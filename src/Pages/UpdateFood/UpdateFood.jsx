...
const UpdateFood = () => {
    ...
    const specifcFood = useLoaderData();
    // console.log("specific food and its id: ", specifcFood, specifcFood._id);
    const { _id, food_img, food_name, food_status, donator_name, donator_email, donator_photo, food_quantity, pickup_location, expire_date, notes } = specifcFood;
    ...
    const handleUpdateFood = e => {
        ...
        fetch(`https://food-campagin-server.vercel.app/availableFoods/${_id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div>
            <h2 className="text-center mt-5 text-4xl font-bold text-red-600">Update Food</h2>
            <div className=" w-8/12 py-10 mx-auto bg-red-50 rounded my-5">
                <form onSubmit={handleUpdateFood} className="max-w-md mx-auto">
                    {/* food image */}
